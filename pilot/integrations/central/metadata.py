...
def _parse_credentials(raw: str, name: str) -> dict[str, str]:
    ...
    credentials = {key: str(payload[key]) for key in REQUIRED_KEYS}
...
def apply_central_config(bench: "Bench", metadata: InstanceMetadata | None = None) -> bool:
