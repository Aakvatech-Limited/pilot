...
export const isMigrationConflict = (exception: unknown) =>
  (exception as { excType?: string } | undefined)?.excType ===
...
export const createPaymentMethodCheckout = (
  redirectUrl: string,
  gateway: string,
) =>
...
export const getTask = (taskId: string) =>
  call("get_task", { task_id: taskId }, "GET");

export const getDomains = () => call("get_domains", {}, "GET");

export const getDomainDnsRecords = (domain: string) =>
  call("get_domain_dns_records", { domain });

export const addDomain = (domain: string) => call("add_domain", { domain });

export const removeDomain = (domain: string) =>
  call("remove_domain", { domain });

export const setPrimaryDomain = (domain: string) =>
  call("set_primary_domain", { domain });
